...
# PRETRAINED_MODELS = {
#     'G.pth': '/share/andy/MeloTTS-main/pretrained_models/G.pth',
#     'D.pth': '/share/andy/MeloTTS-main/pretrained_models/D.pth',
#     'DUR.pth': '/share/andy/MeloTTS-main/pretrained_models/DUR.pth',
# }

# korean female
# PRETRAINED_MODELS = {
#     'G.pth': '/share/andy/MeloTTS-main/checkpoints/checkpoint.pth',
#     'D.pth': '/share/andy/MeloTTS-main/pretrained_models/D.pth',
#     'DUR.pth': '/share/andy/MeloTTS-main/pretrained_models/DUR.pth',
# }

# # korean female + adaptation
# PRETRAINED_MODELS = {
#     'G.pth': '/share/andy/melo_tts/melo/logs/htr_revised_v3_s/G_87000.pth',
#     'D.pth': '/share/andy/melo_tts/melo/logs/htr_revised_v3_s/D_87000.pth',
#     'DUR.pth': '/share/andy/melo_tts/melo/logs/htr_revised_v3_s/DUR_87000.pth',
# }

# ms four -> adaptation
PRETRAINED_MODELS = {
    'G.pth': '/share/andy/melo_tts/melo/logs/ms_four/G_1587000.pth',
    'D.pth': '/share/andy/melo_tts/melo/logs/ms_four/D_1587000.pth',
    'DUR.pth': '/share/andy/melo_tts/melo/logs/ms_four/DUR_1587000.pth',
}
